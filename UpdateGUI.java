...
public class UpdateGUI {
	...
	private void showGUI() {
		...
		begDate = new JTextField("December 31st");
		cap_label2 = new JLabel(" - ");
		endDate = new JTextField("January 7th");
		comma = new JLabel(", ");
		endYear = new JTextField("2016");
		cap_label3 = new JLabel("");
		
		frame.add(cap_label1);
		frame.add(begDate);
		frame.add(cap_label2);
		frame.add(endDate);
		frame.add(comma);
		frame.add(endYear);

		mon = new JLabel("Monday");
		name1 = new JTextField("(Coffee Name)");
		...
		desc1 = new JTextField("(Description)");
		...
		b1.addActionListener(new ActionListener() {
			...
			cap_label3.setText("" + cap_label1.getText().toString() + 
					begDate.getText().toString() + cap_label2.getText().toString() +
					endDate.getText().toString() + comma.getText().toString() + endYear.getText().toString());
			}
		});
